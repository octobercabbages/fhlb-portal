...
var AppEffects = /** @class */ (function () {
    function AppEffects(actions$, store) {
        this.actions$ = actions$;
        this.store = store;
        this.store.dispatch({
            type: auth_1.AuthActionTypes.AppInit
        });
        this.store.select(function (state) { return state; })
            .pipe(operators_1.filter(function (_) { return environment_1.environment.debug; }))
